# Dictionary for nob — swe

This repository contains source files for a dictionary from Norwegian Bokmål to Swedish. The content is licensed under the  license.
